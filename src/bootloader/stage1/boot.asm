...
section .fsheaders
    ...
    %if (FILESYSTEM == fat12) || (FILESYSTEM == fat16) || (FILESYSTEM == fat32)
        ...
        ebr_volume_label:   db 'ArcOS      '
        ebr_system_id:      db 'FAT     '
...
section .entry
    ...
    start:
        ...
        ; move partition entry from MBR to a different location so we don't overwrite it
    ...
    .read_finish:
        ...
        jmp wait_key_and_reboot ; just in case
