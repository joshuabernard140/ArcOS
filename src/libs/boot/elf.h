...
enum ELFProgramType {
    ELF_PROGRAM_TYPE_NULL = 0, //Program header table entry unused
    ELF_PROGRAM_TYPE_LOAD = 1, //Loadable segment
    ELF_PROGRAM_TYPE_DYNAMIC = 2, //Dynamic linking information
    ELF_PROGRAM_TYPE_INTERP = 3, //Interpreter information
    ELF_PROGRAM_TYPE_NOTE = 4, //Auxiliary information
    ELF_PROGRAM_TYPE_SHLIB = 5, //Reserved
    ELF_PROGRAM_TYPE_PHDR = 6, //Segment containing program header table itself
    ELF_PROGRAM_TYPE_TLS = 7, //Thread-Local Storage template
